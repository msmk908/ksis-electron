...
export function Dialog({ size = "full", className, children, ...props }) {
  return (
        ...
        <div className="">
          <Headless.DialogPanel
            ...
            className={clsx(
              className,
              sizes[size],
              "row-start-2 w-full min-w-0 rounded-t-3xl p-[--gutter]  [--gutter:theme(spacing.8)] sm:mb-auto sm:rounded-2xl dark:bg-zinc-900 dark:ring-white/10 forced-colors:outline",
